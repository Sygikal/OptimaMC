...
public abstract class ServerConfigurationManager
{
    ...
    public EntityPlayerMP createPlayerForUser(GameProfile profile)
    {
        ...
        return new EntityPlayerMP(this.mcServer, this.mcServer.worldServerForDimension(0), profile, new ItemInWorldManager(this.mcServer.worldServerForDimension(0)));
    }
    ...
    public EntityPlayerMP recreatePlayerEntity(EntityPlayerMP playerIn, int dimension, boolean conqueredEnd)
    {
        ...
        EntityPlayerMP entityplayermp = new EntityPlayerMP(this.mcServer, this.mcServer.worldServerForDimension(playerIn.dimension), playerIn.getGameProfile(), new ItemInWorldManager(this.mcServer.worldServerForDimension(playerIn.dimension)));
