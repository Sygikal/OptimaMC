...
import net.minecraft.client.gui.controls.GuiNewControls;
...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            {
                this.mc.gameSettings.saveOptions();
                this.mc.displayGuiScreen(new GuiNewControls(this, this.game_settings_1));
            }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, this.field_146442_a, this.width / 2, 12, 16777215);
