...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleSpawnPlayer(S0CPacketSpawnPlayer packetIn)
    {
        ...
        //TODO actually good
        if(this.getPlayerInfo(packetIn.getPlayer()) == null) return;
    ...
    {
    	System.out.println(packetIn.eventType);
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        ...
        if (packetIn.eventType == S42PacketCombatEvent.Event.END_COMBAT)
        {
            ...
            if (entitylivingbase != null)
            {
            	System.out.println("Combat ended between " + this.gameController.thePlayer.getName() + " and " + entitylivingbase.getName());
            }
            else
            {
            	System.out.println("Combat ended between " + this.gameController.thePlayer.getName() + " and others");
            }
            System.out.println("END COMBAT - " + i);
        }
        else if (packetIn.eventType == S42PacketCombatEvent.Event.ENTITY_DIED)
        {
            ...
            {
            	//TODO investigate
                System.out.println(packetIn.deathMessage);
                if ((EntityPlayer)entity1 != null)
                {
                	System.out.println("player " +  ((EntityPlayer)entity1).getName());
                }

                if (entitylivingbase != null)
                {
                	System.out.println("killer" + entitylivingbase.getName());
                }
            }
        }
    }
